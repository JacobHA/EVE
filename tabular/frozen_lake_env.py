...
class ModifiedFrozenLake(DiscreteEnv):
    ...
    def __init__(
        ...
        def periodic_bc_inc(row, col, action):
            if action == a_left:
                col = col - 1
            elif action == a_down:
                row = row + 1
                ...
                raise ValueError("Invalid action provided")
            # now check if a boundary was hit:
            if row < 0:
                row = nrow - 1
            elif row >= nrow:
                row = 0
...
MAPS = {
    ...
    "montezuma": [
        "SFFFFFFFFFFFFF",   # Room 1 (start)
        "FFFFFFFFFFFFFF",
        "FFFFFFFFFFFFFF",
        "FFFFFFFFFFFFFF",
        "FFFFFFFFFFFFFF",
        "WWWWWWWWWFWWWW",   # Narrow horizontal wall with a 1-tile gap (hallway entrance)
        "WWWWWWWWWFWWWW",   # Narrow horizontal wall with a 1-tile gap (hallway entrance)
        "FFFFFFFFFFFFFF",   # Room 2 (goal)
        "FFFFFFFFFFFFFF",
        "WFWWWWWWWWWWWW",
        "WFFFFFFFFFFFFF",
    ],
    ...
    "15x45m": [
    "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF",
    "FWWWWWWWWWWWWWWFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF",
    "FWFFFFFFFFFFFFFFFWWWWWWWWWWWWWWWWWWWWWWWWWFFF",
    "FWFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFWFFF",
    "FWFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFWFFF",
    "FWWWWWWWWWWWWWWWWFFFFFFFFFFFFFFFFFFFFFFFWWFFF",
    "FFFFFFFFFFFFFFFFFWWWWWWWWWWWWWWWWWWWWWWWFWFFF",
    "FFFFFFSFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFWFWFFFF",
    "FWFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFWFFFFF",
    "FWFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFWWWWW",
    "FWWWWWWWWWWWWWWWWFFFFFFFFFFFFFFFFFFFFFFFFFFFF",
    "FFFFFFFFFFFFFFFFFWWWWWWWWWWWWWWWWWWWWWWWWFFFF",
    "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFWFFF",
    "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF",
],
